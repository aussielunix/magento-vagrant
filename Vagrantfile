raise ArgumentError, "ENV['aws_access_key_id'] is empty." unless ENV['aws_access_key_id']
raise ArgumentError, "ENV['aws_secret_access_key'] is empty." unless ENV['aws_secret_access_key']
raise ArgumentError, "ENV['aws_keypair_name'] is empty." unless ENV['aws_keypair_name']
